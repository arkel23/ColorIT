...
import colorit
from .configs_vanilla import ViTVanillaConfig
...
def convert_single(name, filename):
    ...
    cfg = ViTVanillaConfig(model_name=name, load_repr_layer=load_repr_layer,
                           image_size=image_size, num_classes=num_classes)
    model = colorit.ViTVanilla(cfg, pretrained=False)
